...
const AboutHeroSection = () => {
  ...
  return (
    <section className="min-h-[125vh] md:min-h-screen w-full relative bg-white font-sans overflow-hidden">
      ...
      {/* Main Content */}
      <main className="absolute top-[40%] sm:top-[45%] md:top-1/2 left-0 md:left-32 lg:left-48 xl:left-56 max-w-2xl transform -translate-y-1/2 w-full px-6 sm:px-8 md:px-0 z-10">
