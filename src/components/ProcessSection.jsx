...
const ProcessSection = () => {
  return (
    <section className="min-h-screen h-full w-full snap-start relative font-sans overflow-y-auto bg-[#0a0a0a] flex items-center">
      ...
      <div className="relative z-10 w-full flex flex-col py-20 md:py-24 lg:py-28 px-6 sm:px-8 md:pl-32 lg:pl-48 xl:pl-56 md:pr-12 lg:pr-16 max-w-[1600px] mx-auto">
        ...
        <div className="relative">
          ...
          <div className="hidden lg:block absolute top-7 left-0 right-0 h-[2px] bg-linear-to-r from-[#a4d64f]/0 via-[#a4d64f]/40 to-[#a4d64f]/0" />

          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-5 gap-8 md:gap-10 lg:gap-6">
            {steps.map((step, idx) => (
              <div key={step.number} className="relative flex lg:flex-col gap-5 lg:gap-0 group">
                {/* Mobile vertical connector */}
                {idx < steps.length - 1 && (
                  <div className="lg:hidden absolute left-7 top-14 -bottom-8 w-[2px] bg-linear-to-b from-[#a4d64f]/40 to-transparent" />
                )}
                ...
                {/* Content */}
                <div className="flex-1 lg:mt-6 lg:pr-4">
                  <h4 className="text-white font-gilroy font-bold text-lg md:text-xl mb-2 group-hover:text-[#a4d64f] transition-colors duration-300">
                    {step.title}
                  </h4>
